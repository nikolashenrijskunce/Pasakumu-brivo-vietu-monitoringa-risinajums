...
def get_ticket_info(event_id: int):
    ...
    for group in price_groups:
        ...
        #     aggregated[price] = {"price": price, "available_seats": 0, "category": category}
        # aggregated[price]["available_seats"] += count

        # TODO: jasataisa taa, ka updateo, ja ir conflict ar price un event id. Vai ari ir jataisa custom key, ko veido event id + price
        cur.execute("""
